...
- Simply use Reposcope. You can analyze any single GitHub repository/developers in depth, compare any two repositories using the same metrics, and provide comprehensive, valuable, and trending open source insights.
  - If you have any questions or want to share ideas when using  Reposcope, you can make a discussion on [GitHub Discussions](https://github.com/sps-exe/reposcope/discussions).
  - Does everything work as expected? If not, we're always looking for improvements. Let us know by [**opening an issue**](https://github.com/sps-exe/reposcope/blob/main/CONTRIBUTING.md#issue).
- If you want to add a collection on our Reposcope website, you can also [**add a collection**](https://github.com/sps-exe/reposcope/blob/main/CONTRIBUTING.md#add-a-collection) by submitting PRs.
- Look through the [open issues](https://github.com/sps-exe/reposcope/issues). Provide workarounds, ask for clarification, or suggest labels. If you find an issue you would like to fix, [**open a pull request**](https://github.com/sps-exe/reposcope/blob/main/CONTRIBUTING.md#pull-requests). 
...
- If you have message or experience about using Reposcope, you are welcome to [**add a new blog**](https://github.com/sps-exe/reposcope/blob/main/CONTRIBUTING.md#add-a-blog).
...
When [opening a new issue](https://github.com/sps-exe/reposcope/issues/new/choose), you can choose an issue template and always make sure to fill out the issue template. 

### Bugs

We use [GitHub Issues](https://github.com/sps-exe/reposcope/issues) for our public bugs. If you would like to report a problem, take a look around and see if someone already opened an issue about it. If you are certain this is a new, unreported bug, you can submit a [bug report](https://github.com/sps-exe/reposcope/issues/new?assignees=&labels=&template=bug_report.md&title=).
...
If you would like to request a new feature or enhancement but are not yet thinking about opening a pull request, you can submit a [feature request](https://github.com/sps-exe/reposcope/issues/new?assignees=&labels=&template=feature_request.md&title=).
...
`config: add facebook/react repo to web framework collection`
...
Please create a `.yml` file under [the collections file path]( https://github.com/sps-exe/reposcope/tree/main/configs/collections).

* File Name

`<collection_id>.<collection_name>.yml`, For example: `10013.game-engine.yml`

  💡 Tips: Please use `100XX` as your collection's id，and it should be `+1` after the latest submit in [here]( https://github.com/sps-exe/reposcope/tree/main/configs/collections). 
...
Please create a folder under [`apps/docs/content/blog/`]( https://github.com/sps-exe/reposcope/tree/main/apps/docs/content/blog), and create a `.md` file under the folder.

* Folder Name: describe the text briefly

For example: `the-openclaw-forks-wave-2026`
