...
const sections = [
  {
    title: 'Blog',
    description: 'Product stories, engineering write-ups, and yearly insight reports migrated from the legacy Reposcope site.',
    href: '/blog',
    icon: Newspaper,
  },
  {
    ...
    >
      <div className="docs-shell">
        <section className="mx-auto max-w-3xl text-center">
          <div className="text-[11px] uppercase tracking-[0.28em] text-[#22d3ee]">Reposcope Docs</div>
          ...
          <p className="mt-4 text-[15px] leading-7 text-slate-400 sm:text-base">
            This app hosts the editorial side of Reposcope while keeping navigation and color aligned with the main
            ...
            {sections.map((section) => {
              ...
              return (
                <li key={section.href}>
                  ...
                  >
                    <span className="mt-0.5 inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/[0.04] text-[#22d3ee]">
