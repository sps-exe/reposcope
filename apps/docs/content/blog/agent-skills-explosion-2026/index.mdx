...
keywords: [agent skills, AGENTS.md, CLAUDE.md, claude code skills, coding agent skills, ai developer workflow, github analytics 2026, Reposcope, open source AI tools, developer tools trends]
---
...
|-----------|-------|---------|-------------|
| [affaan-m/everything-claude-code](https://reposcope.io/analyze/affaan-m/everything-claude-code) | 102,235 | Jan 18 | ~9 days |
| [VoltAgent/awesome-openclaw-skills](https://reposcope.io/analyze/VoltAgent/awesome-openclaw-skills) | 41,339 | Jan 25 | ~12 days |
| [sickn33/antigravity-awesome-skills](https://reposcope.io/analyze/sickn33/antigravity-awesome-skills) | 26,892 | Jan 14 | ~11 days |
| [OthmanAdi/planning-with-files](https://reposcope.io/analyze/OthmanAdi/planning-with-files) | 16,966 | Jan 3 | ~18 days |
| [kepano/obsidian-skills](https://reposcope.io/analyze/kepano/obsidian-skills) | 16,422 | Jan 2 | ~22 days |
| [vercel-labs/skills](https://reposcope.io/analyze/vercel-labs/skills) | 11,472 | Jan 14 | ~17 days |
| [JimLiu/baoyu-skills](https://reposcope.io/analyze/JimLiu/baoyu-skills) | 10,873 | Jan 13 | ~22 days |
...
|-----------|---------------|-------------|-------|-------------|
| [sickn33/antigravity-awesome-skills](https://reposcope.io/analyze/sickn33/antigravity-awesome-skills) | **629** | 143 | 4,562 | 1 |
| [affaan-m/everything-claude-code](https://reposcope.io/analyze/affaan-m/everything-claude-code) | **365** | 113 | 13,326 | 103 |
| [openclaw/clawhub](https://reposcope.io/analyze/openclaw/clawhub) | **323** | — | 1,050 | 638 |
| [VoltAgent/awesome-openclaw-skills](https://reposcope.io/analyze/VoltAgent/awesome-openclaw-skills) | **130** | 64 | 3,950 | 41 |
| [vercel-labs/skills](https://reposcope.io/analyze/vercel-labs/skills) | **31** | 81 | 924 | 360 |
...
Personal skill collections are performing as well as org-backed projects. [JimLiu/baoyu-skills](https://reposcope.io/analyze/JimLiu/baoyu-skills) (10,873 stars), [mattpocock/skills](https://reposcope.io/analyze/mattpocock/skills) (9,442 stars), [phuryn/pm-skills](https://reposcope.io/analyze/phuryn/pm-skills) (8,029 stars, created March 1st — 24 days ago).
...
The ecosystem is growing fast, but it's not converging. A few dominant repos account for the vast majority of stars and forks. Skill content is [heavily concentrated and duplicative](https://arxiv.org/abs/2602.08004) — many collections cover the same narrow set of use cases. A [significant portion have security vulnerabilities](https://arxiv.org/abs/2601.10338). And the [long tail is vast and largely unused](https://olshansky.info/posts/2026-02-28-signal-vs-noise-in-the-skills-ecosystem/) — thousands of published skills that nobody installs.
...
**1. Fork/star ratio on [everything-claude-code](https://reposcope.io/analyze/affaan-m/everything-claude-code).** Currently ~13%. If it stays above 10%, people are genuinely customizing and using skills. If it drops below 5%, skills are becoming bookmarks, not tools.

**2. Issue velocity on [openclaw/clawhub](https://reposcope.io/analyze/openclaw/clawhub) and [vercel-labs/skills](https://reposcope.io/analyze/vercel-labs/skills).** High issue counts with slow resolution means people are hitting the limits of the abstraction. If the issues are mostly "how do I do X that skills can't express?" — that's the transitional layer straining under the weight of what comes next.
...
*Explore the repos mentioned in this analysis on [Reposcope](https://reposcope.io) — real-time GitHub analytics for open source.*
