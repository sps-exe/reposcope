...
keywords: [autoresearch, karpathy, AI scientist, autonomous agent, self-improving AI, research agent, GitHub trending 2026, agentic AI, ai research automation, reposcope]
---
...
That's 19 days. That's [karpathy/autoresearch](https://reposcope.io/analyze/karpathy/autoresearch).

For context: [karpathy/nanoGPT](https://reposcope.io/analyze/karpathy/nanoGPT) — which basically triggered the small-model Renaissance — took three years to reach the same number. His follow-up, [karpathy/nanochat](https://reposcope.io/analyze/karpathy/nanochat), got there in 160 days. autoresearch did it in 19.
...
|-----------|-------|-------------|-----------|
| [karpathy/autoresearch](https://reposcope.io/analyze/karpathy/autoresearch) | 54,553 | **19** | **2,871** |
| [karpathy/nanochat](https://reposcope.io/analyze/karpathy/nanochat) | 50,217 | ~160 | ~314 |
| [karpathy/nanoGPT](https://reposcope.io/analyze/karpathy/nanoGPT) | 55,526 | ~1,100 | ~50 |
| [karpathy/llm.c](https://reposcope.io/analyze/karpathy/llm.c) | 29,258 | ~350 | ~84 |
...
|-----------|-------|---------|-------------|
| [karpathy/autoresearch](https://reposcope.io/analyze/karpathy/autoresearch) | 54,553 | Mar 6 | AI agents run ML experiments overnight |
| [jennyzzt/dgm](https://reposcope.io/analyze/jennyzzt/dgm) | 1,944 | May 2025 | Darwin Gödel Machine: open-ended evolution of self-improving agents |
| [facebookresearch/HyperAgents](https://reposcope.io/analyze/facebookresearch/HyperAgents) | 666 | Mar 19 | Self-referential agents that optimize for any computable task |
| [zerobootdev/zeroboot](https://reposcope.io/analyze/zerobootdev/zeroboot) | 1,885 | Mar 2026 | Sub-millisecond VM sandboxes for AI agents to run safely |
...
| [openai/swarm](https://reposcope.io/analyze/openai/swarm) | 2,258 | 13 | 174 |
| [wshobson/agents](https://reposcope.io/analyze/wshobson/agents) | 3,516 | 43 | 82 |
...
1. **Automated hypothesis generation** — not just running experiments, but deciding *which* experiments to run based on prior results. [jennyzzt/dgm](https://reposcope.io/analyze/jennyzzt/dgm) (1,944 stars) is already exploring this: agents that evolve their own objectives, not just optimize a fixed one.
...
3. **Evaluation bootstrapping** — agents that improve their own benchmarks, not just their performance on fixed ones. [facebookresearch/HyperAgents](https://reposcope.io/analyze/facebookresearch/HyperAgents) (666 stars, created March 19) is a week old and already exploring self-referential optimization.
...
*Explore the GitHub velocity data yourself at [reposcope.io/analyze/karpathy/autoresearch](https://reposcope.io/analyze/karpathy/autoresearch). For context on the coding agent landscape this sits on top of, see our analysis of [The Coding Agent Wars](https://reposcope.io/blog/coding-agent-wars-2026).*
