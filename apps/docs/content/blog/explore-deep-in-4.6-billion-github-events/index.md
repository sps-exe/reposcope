...
authors: [fendy]
tags: [tidbcloud]
image: /blog-assets/explore-deep-in-4.6-billion-github-events/banner-reposcope-explore-deep.jpg
...
Here you go: [Reposcope.io](https://reposcope.io/)** can help you find the answer**. It’s a useful insight tool that can give you the most updated open source intelligence, and help you deeply understand any single GitHub project or quickly compare any two projects by digging deep into 4.6 billion GitHub events in real time. Here are some ways you can play with it.

## Compare any two GitHub projects

Do you wonder how different projects have performed and developed over time? Which project is worthy of more attention? **[Reposcope.io](https://reposcope.io/)** can answer your questions via the [Compare Projects](https://reposcope.io/analyze/pingcap/tidb) page.
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/the-star-history.png)
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/geographicla-distribution-of-stargazers.png)
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/employment-distribution-of-stargazers.png)
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/monthly-pushes-and-commits.png)
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/monthly-and-accumulated-pr-number.png)
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/heat-map.png)
...
Popularity and coding vitality are just two dimensions to compare repositories. If you want to discover more insights or compare other projects you are interested in, feel free to visit the [Compare](https://reposcope.io/analyze/pingcap/tidb) page and explore it for yourself.  
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/panoramic-view-of-key-github-metrics.png)

<center><em>Panoramic view of key GitHub metrics (K8s as an example)</em></center>

<br />

![](/blog-assets/explore-deep-in-4.6-billion-github-events/total-pr-number-each-month-and-pr-groups.png)

<center><em>  Total PR number each month/PR groups (K8s as an example)</em></center>

<br />

![](/blog-assets/explore-deep-in-4.6-billion-github-events/number-of-lines-of-code-change-each-month.png)
...
[Reposcope.io](https://reposcope.io/) does more than explore or compare repositories. **It gives you [historical, real-time, and custom open source insights](https://reposcope.io/database/deep-insight-into-open-source-databases).** In this section, we’ll share some key insights in open source databases and programming languages. If you want to gain insights in other areas, you can explore the [Insights](https://reposcope.io/database/deep-insight-into-open-source-databases/)  page for yourself. 

**Note**: If you want to get those analytical results by yourself, you can execute the SQL commands above each chart on TiDB Cloud with ease following this [10-minute tutorial](https://reposcope.io/blog/try-it-yourself/). 
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/pr-number-of-pl-repos.png)
...
According to **[Reposcope.io](https://reposcope.io/)**, 10 programming languages dominate the open source community. Go is the most popular with 108,317 stars, followed by Node and TypeScript. Go is also the fastest growing language in popularity.
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/star-growth-trends-of-leading-programming-languages.png)
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/companies-who-contribute-the-most-to-programing-languages.png)
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/star-growth-trend-of-leading-databases.png)
...
![](/blog-assets/explore-deep-in-4.6-billion-github-events/geographical-distribution-database-stargazers.png)


<center><em>The geographical distribution of open source database stargazers</em></center>


**[Reposcope.io](https://reposcope.io/)** also allows you to create your own custom insights into any GitHub repository created after 2011. You’re welcome to visit the [Insights page](https://reposcope.io/database/deep-insight-into-open-source-databases) to explore more. 


## Run your own analytics with TiDB Cloud

All the analytics on **[Reposcope.io](https://reposcope.io/)** are powered by [TiDB Cloud](https://www.pingcap.com/tidb-serverless/), a fully-managed database as a service. If you want to run your own analytics and get your own insights, [sign up for a TiDB Cloud account](https://tidbcloud.com/free-trial/?utm_source=reposcope&utm_medium=community) and try it for yourself with this [10-minute tutorial](https://reposcope.io/blog/try-it-yourself/).

## Contact us 

Do you find **[Reposcope.io](https://reposcope.io/)** useful and fun to work with? Do you have any question or feedback to share with us? Feel free to [file an issue](https://github.com/reposcope/reposcope/issues/new) on GitHub or follow us on [Twitter](https://twitter.com/Reposcope/) to get the latest information. You’re also welcome to share this insight tool with your friends. 
