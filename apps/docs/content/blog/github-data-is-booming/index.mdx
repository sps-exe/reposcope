...
tags: [insight]
image: /blog-assets/github-data-is-booming/github-data-is-booming.jpg
...
The Reposcope database includes all the GitHub events since 2011. When we plot the number of events by year, we can see that since 2018 they have been increasing rapidly.

<br />

![GitHub event trending](/blog-assets/github-data-is-booming/github-event-trending.jpg)
...
![The time to reach a billion GitHub events](/blog-assets/github-data-is-booming/github-data-is-booming.jpg)
...
![Bot events vs. human events](/blog-assets/github-data-is-booming/bot-events-vs-human-events.jpg)
...
![Bot event trending](/blog-assets/github-data-is-booming/bot-event-trending.jpg)

<center><em>Bot event trending</em></center>

<br />

This figure shows that since 2019, bot events have been grown faster than before. As [Mini256](https://github.com/Mini256), a TiDB community contributor said in [Love, Code, and Robot — Explore robots in the world of code](https://reposcope.io/blog/say-thanks-to-github-robots):
...
![Human event fit (left) vs. bot event fit (right)](/blog-assets/github-data-is-booming/human-event-fit-vs-bot-event-fit.jpg)
...
<center>
<img src="/blog-assets/github-data-is-booming/github-event-prediction.jpg" width="50%" alt="github-event-prediction"/>
</center>
...
<center>
<img src="/blog-assets/github-data-is-booming/gitub-events-exceed-10-billion.jpg" width="50%" alt="gitub-events-exceed-10-billion"/>
</center>
...
All the analysis data in this article comes from [Reposcope](https://reposcope.io/), a tool based on [TiDB]( https://www.pingcap.com/tidb-serverless/?utm_source=reposcope&utm_medium=referral) to analyze and gain insights into GitHub events data.
...
![The Reposcope website](/blog-assets/github-data-is-booming/oss-insight-website.png)

<center><em>The Reposcope website</em></center>
