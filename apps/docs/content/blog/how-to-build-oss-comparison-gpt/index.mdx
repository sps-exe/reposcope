...
2. Reposcope API for star history and stargazer's distribution
3. Hackernews mentions per_year API
4. Reposcope star history chart API (show me with a <img> label)
5. Reposcope API for  stargazers company distribution
...
#### Action 1: Config API of next.reposcope.io for drawing star historical chart

##### Schema
```yaml
openapi: 3.0.0
info:
  title: Reposcope star history chart API
  version: 1.0.0
  description: Reposcope star history chart API.
servers:
  - url: https://next.reposcope.io
paths:
...
Or you can use the following detailed schema.
