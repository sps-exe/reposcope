...
keywords: [garrytan gstack, personal AI stack, claude code skills, mattpocock skills, slavingia skills, developer productivity 2026, github trending, reposcope, AI coding workflow, open source tooling]
---
...
[garrytan/gstack](https://reposcope.io/analyze/garrytan/gstack) hit 50,000+ stars in 16 days. [mattpocock/skills](https://reposcope.io/analyze/mattpocock/skills) crossed 10,000 stars over 52 days. [slavingia/skills](https://reposcope.io/analyze/slavingia/skills) got 3,600+ stars in its first *four days*.
...
> *Disclosure: Reposcope is built by [PingCAP](https://pingcap.com). We have no affiliation with any projects analyzed here. All data from public GitHub APIs as of March 27, 2026.*
...
|-----------|---------|------|-------|---------|-----------|
| [garrytan/gstack](https://reposcope.io/analyze/garrytan/gstack) | Garry Tan | President & CEO, Y Combinator | 50,376 | Mar 11, 2026 | 3,148 |
| [mattpocock/skills](https://reposcope.io/analyze/mattpocock/skills) | Matt Pocock | Creator of TypeScript tutorial series, author of *Total TypeScript* | 10,360 | Feb 3, 2026 | 199 |
| [slavingia/skills](https://reposcope.io/analyze/slavingia/skills) | Sahil Lavingia | Founder & CEO, Gumroad | 3,675 | Mar 23, 2026 | 919 |
...
(You can explore these metrics yourself — try the [head-to-head comparison](https://reposcope.io/analyze/garrytan/gstack?vs=mattpocock/skills) on Reposcope.)
...
*Compare the top personal AI stack repos on Reposcope:*
- [garrytan/gstack](https://reposcope.io/analyze/garrytan/gstack)
- [mattpocock/skills](https://reposcope.io/analyze/mattpocock/skills)
- [slavingia/skills](https://reposcope.io/analyze/slavingia/skills)
