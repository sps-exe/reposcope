...
image: /blog-assets/saas-insight-for-building-a-real-time-crm-application/thumbnail.png
date: 2022-05-01
authors: [ilovesoup]
tags: [tidb]
---
...
4. Optionally, **deploy a couple of [TiFlash](https://docs.pingcap.com/tidb/stable/tiflash-overview?utm_source=reposcope&utm_medium=referral) nodes** to speed up large scale reporting queries.
...
For more cases, please see [here](https://en.pingcap.com/customers/?utm_source=reposcope&utm_medium=referral).



> **Details in how Reposcope works**
>
> Go to read [Use TiDB Cloud to Analyze GitHub Events in 10 Minutes](/blog/try-it-yourself) and use the [Serverless Tier](https://tidbcloud.com/free-trial/?utm_source=reposcope&utm_medium=community) TiDB Cloud Cluster.
>
