...
date: 2022-05-12
authors: [Mini256]
image: /blog-assets/say-thanks-to-github-robots/love-code-robots-cover.png
...
In the [Reposcope](https://reposcope.io/) project, we have developed a number of metrics to provide insight into open source projects. When developing some open source project metrics, we always consider excluding bot-generated actions or events from the metric calculation. 
...
[![Bot automatically completes a pull request](/blog-assets/say-thanks-to-github-robots/bot_automatically_completes_a_pull_request.png)](https://github.com/buildo/react-components/pull/1367)
...
- Some are even crazier, and you can't even access their profile pages because the number of events generated is so large that GitHub's database can't process them quickly, for example, `mhutchinson-witness`, `direwolf-github`.
    ...
    ![Too long time to load bot profile](/blog-assets/say-thanks-to-github-robots/too_long_time_to_load_profile.png)
