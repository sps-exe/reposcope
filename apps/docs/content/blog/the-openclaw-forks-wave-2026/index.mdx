...
keywords: [openclaw alternatives, nanobot, zeroclaw, picoclaw, nanoclaw, lightweight AI assistant, personal AI agent, github trending 2026, reposcope, open source AI fragmentation, AI agent runtime]
---

Four teams. Four languages. Eight weeks. 116,000 stars. Each one a from-scratch rewrite of [OpenClaw](https://reposcope.io/analyze/openclaw/openclaw) — the 336K-star personal AI assistant that went from zero to GitHub history in four months.
...
> *Disclosure: Reposcope is an independent, open-source project. We have no affiliation with any of the projects analyzed in this post. All data is from public GitHub APIs.*

| Repository | Language | Stars | Created | Contributors |
|-----------|----------|-------|---------|-------------|
| [HKUDS/nanobot](https://reposcope.io/analyze/HKUDS/nanobot) | Python | 36,283 | Feb 1, 2026 | ~204 |
| [zeroclaw-labs/zeroclaw](https://reposcope.io/analyze/zeroclaw-labs/zeroclaw) | Rust | 28,790 | Feb 13, 2026 | ~215 |
| [sipeed/picoclaw](https://reposcope.io/analyze/sipeed/picoclaw) | Go | 26,142 | Feb 4, 2026 | ~187 |
| [qwibitai/nanoclaw](https://reposcope.io/analyze/qwibitai/nanoclaw) | TypeScript | 25,489 | Jan 31, 2026 | ~62 |
...
We read the code. Here's what they each believe. ([Compare them head-to-head on Reposcope →](https://reposcope.io/analyze/HKUDS/nanobot?vs=zeroclaw-labs%2Fzeroclaw))
...
[HKUDS/nanobot](https://reposcope.io/analyze/HKUDS/nanobot) comes from the Data Intelligence Lab at the University of Hong Kong (HKU). Its headline claim:
...
[zeroclaw-labs/zeroclaw](https://reposcope.io/analyze/zeroclaw-labs/zeroclaw) makes a different bet entirely. Their claim:
...
[sipeed/picoclaw](https://reposcope.io/analyze/sipeed/picoclaw) comes from Sipeed — the Chinese maker hardware company known for affordable RISC-V boards. Where ZeroClaw targets Raspberry Pi and ESP32, PicoClaw targets Sipeed's own ecosystem: K210 chips, Tang Nano FPGAs, MAIX boards.
...
[qwibitai/nanoclaw](https://reposcope.io/analyze/qwibitai/nanoclaw) is the outlier — and it's where the most interesting signal lives.
...
*Explore more:*
- *[openclaw/openclaw on Reposcope](https://reposcope.io/analyze/openclaw/openclaw)*
- *[HKUDS/nanobot on Reposcope](https://reposcope.io/analyze/HKUDS/nanobot)*
- *[zeroclaw-labs/zeroclaw on Reposcope](https://reposcope.io/analyze/zeroclaw-labs/zeroclaw)*
- *[sipeed/picoclaw on Reposcope](https://reposcope.io/analyze/sipeed/picoclaw)*
- *[qwibitai/nanoclaw on Reposcope](https://reposcope.io/analyze/qwibitai/nanoclaw)*
