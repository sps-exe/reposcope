...
tags: [insight]
image: /blog-assets/trends-and-insights-from-github-2022/open-source-highlights-trends-and-insights-from-github-2022.png
...
We analyzed more than 5,000,000,000 rows of GitHub event data and got the results here. In this [report](https://reposcope.io/2022/), you'll get interesting findings about open source software on GitHub in 2022, including:
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/top-programming-languages.png" width="80%" alt="top-programming-languages"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/top-back-end-programming-languages.png" width="80%" alt="top-back-end-programming-languages"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/geographic-distribution-of-developer-behavior.png" width="80%" alt="geographic-distribution-of-developer-behavior"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/developer-behavior-distribution-on-weekdays-and-weekends.png" width="80%" alt="developer-behavior-distribution-on-weekdays-and-weekends"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/developer-behavior-distribution-from-monday-to-sunday.png" width="80%" alt="developer-behavior-distribution-from-monday-to-sunday"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/activity-levels-of-popular-topics.png" width="80%" alt="activity-levels-of-popular-topics"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/low-code-repositories.png" width="80%" alt="low-code-repositories"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/web3-repositories.png" width="80%" alt="web3-repositories"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/github-actions-repositories.png" width="80%" alt="github-actions-repositories"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/database-repositories.png" width="80%" alt="database-repositories"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/ai-repositories.png" width="80%" alt="ai-repositories"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/most-popular-repositories-2022.png" width="80%" alt="most-popular-repositories-2022"/>
</center>
...
| --- | --- |
| [microsoft/vscode](https://reposcope.io/analyze/microsoft/vscode) | 4 |
| [flutter/flutter](https://reposcope.io/analyze/flutter/flutter) | 4 |
| [MicrosoftDocs/azure-docs](https://reposcope.io/analyze/MicrosoftDocs/azure-docs) | 4 |
| [firstcontributions/first-contributions](https://reposcope.io/analyze/firstcontributions/first-contributions) | 4 |
| [Facebook/react-native](https://reposcope.io/analyze/Facebook/react-native) | 4 |
| [pytorch/pytorch](https://reposcope.io/analyze/pytorch/pytorch) | 4 |
| [microsoft/TypeScript](https://reposcope.io/analyze/microsoft/TypeScript) | 4 |
| [tensorflow/tensorflow](https://reposcope.io/analyze/tensorflow/tensorflow) | 3 |
| [kubernetes/kubernetes](https://reposcope.io/analyze/kubernetes/kubernetes) | 3 |
| [DefinitelyTyped/DefinitelyTyped](https://reposcope.io/analyze/DefinitelyTyped/DefinitelyTyped) | 3 |
| [golang/go](https://reposcope.io/analyze/golang/go) | 3 |
| [google/it-cert-automation-practice](https://reposcope.io/analyze/google/it-cert-automation-practice) | 3 |
| [home-assistant/core](https://reposcope.io/analyze/home-assistant/core) | 3 |
| [microsoft/PowerToys](https://reposcope.io/analyze/microsoft/PowerToys) | 3 |
| [microsoft/WSL](https://reposcope.io/analyze/microsoft/WSL) | 3 |
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/developers-most-stars.png" width="80%" alt="developers-most-stars"/>
</center>
...
<center>
<img src="/blog-assets/trends-and-insights-from-github-2022/most-active-developers.png" width="80%" alt="most-active-developers"/>
</center>
...
| **Web3** |  | `web3` |
| **Database** | `db` | `database`, `databases`<br />`nosql`, `newsql`, `sql`<br />`mongodb`, `neo4j` |
| **AI** | `ai`, `aiops`, `aiot` | `artificial-intelligence`, `machine-intelligence`<br />`computer-vision`, `image-processing`, `opencv`, `computervision`, `imageprocessing`<br />`voice-recognition`, `speech-recognition`, `voicerecognition`, `speechrecognition`, `speech-processing`<br />`machinelearning`, `machine-learning`<br />`deeplearning`, `deep-learning`<br />`transferlearning`, `transfer-learning`<br />`mlops`<br />`text-to-speech`, `tts`, `speech-synthesis`, `voice-synthesis`<br />`robot`, `robotics`<br />`sentiment-analysis`<br />`natural-language-processing`, `nlp`<br />`language-model`, `text-classification`, `question-answering`, `knowledge-graph`, `knowledge-base`<br />`gan`, `gans`, `generative-adversarial-network`, `generative-adversarial-networks`<br />`neural-network`, `neuralnetwork`, `neuralnetworks`, `neural-network`, `dnn`<br />`tensorflow`<br />`PyTorch`<br />`huggingface`<br />`transformers`<br />`seq2seq`, `sequence-to-sequence`<br />`data-analysis`, `data-science`<br />`object-detection`, `objectdetection`<br />`data-augmentation`<br />`classification`<br />`action-recognition` |
