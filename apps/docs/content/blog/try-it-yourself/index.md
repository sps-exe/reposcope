...
tags: [tidbcloud]
image: /blog-assets/try-it-yourself/import.png
...
[TiDB](https://docs.pingcap.com/tidb/stable/overview?utm_source=reposcope&utm_medium=referral) is an open source distributed NewSQL database with horizontal scalability, high availability, and strong consistency. It can also deal with mixed OLTP and OLAP workloads at the same time by leveraging its hybrid transactional and analytical (HTAP) capability. 

**[TiDB Cloud](https://docs.pingcap.com/tidbcloud/public-preview?utm_source=reposcope&utm_medium=referral) is a fully-managed Database-as-a-Service (DBaaS)** that brings everything great about TiDB to your cloud and lets you focus on your applications, not the complexities of your database. 
...
1. Click [here](https://tidbcloud.com/free-trial/?utm_source=reposcope&utm_medium=community) to sign up for a TiDB Cloud account free of charge. 
2. [Log in](https://tidbcloud.com/?utm_source=reposcope&utm_medium=community) to your account.
...
![](/blog-assets/try-it-yourself/dev-tier.png)
...
![](/blog-assets/try-it-yourself/import.png)
...
![](/blog-assets/try-it-yourself/fill.png)
...
![](/blog-assets/try-it-yourself/web-shell.png)


### Set column storage replica: TiFlash (Optional but could make SQL faster!) 

[TiFlash](https://docs.pingcap.com/tidb/stable/tiflash-overview?utm_source=reposcope&utm_medium=referral) is the key component that makes TiDB / TiDB Cloud an HTAP database and capable of dealing with OLTP and OLAP workloads at the same time. 
...
> **Details in how Reposcope works**
>
> Find the reason [How we implement Reposcope ?](/blog/why-we-choose-tidb-to-support-reposcope).
>
