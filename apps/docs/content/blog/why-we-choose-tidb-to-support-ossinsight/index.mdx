...
tags: [tidb]
image: /blog-assets/why-we-choose-tidb-to-support-reposcope/how-different-db-handle-github-data.png
description: The story about how we build the reposcope project, including how we deal with the historical and real-time huge data, the database solutions and so on.
...
![GitHub event updates](/blog-assets/why-we-choose-tidb-to-support-reposcope/github-events-updates.gif)
...
![The data volume of GitHub events occurred after 2011](/blog-assets/why-we-choose-tidb-to-support-reposcope/github-events.png)
...
<center>
  <img width="50%" src="/blog-assets/why-we-choose-tidb-to-support-reposcope/scalability-SQL.jpg" alt='Scalability vs SQL' />
</center>
...
<center>
  <img width="50%" src="/blog-assets/why-we-choose-tidb-to-support-reposcope/olap-onlineserving.jpg" alt='OLAP vs Online Serving' />
</center>
...
![How a RDBMS handles the GitHub data](/blog-assets/why-we-choose-tidb-to-support-reposcope/sharded-architecture.png)
...
![By using the secondary index, TiDB scanned 29,639 rows (instead of 4.6 billion rows) GitHub events in 4.9 ms](/blog-assets/why-we-choose-tidb-to-support-reposcope/tidb-scanned-kennytm.png)
...
**To choose a database to support an application like Reposcope, we think TiDB is a great choice.** Plus, its simplified technology stack means a faster go-to-market and faster delivery of my boss' assignment. 

After we used TiDB, we got a simplified architecture as shown below. 

<br />

![Simplified architecture after we use TiDB](/blog-assets/why-we-choose-tidb-to-support-reposcope/how-different-db-handle-github-data.png)
...
Finally, we made it. We prototyped our tool in just one week, and named it [Reposcope](https://reposcope.io/), short for open source software insights. We continued to fine-tune it, and it was [officially released](https://reposcope.io/blog/explore-deep-in-4.6-billion-github-events/) on May 3. 
...
[Reposcope](https://reposcope.io/) can analyze popular GitHub collections by many metrics including the number of stars, issues, and contributors. Let’s identify which JavaScript framework has the most issue creators. 
...
Then, we just need to draw [the result](https://reposcope.io/blog/deep-insight-into-js-framework-2021/#which-javascript-framework-have-the-widest-feedback-sources) with Apache Echarts into a more visualized chart as shown below. 

<br />

![JavaScript frameworks with the most issue creators](/blog-assets/why-we-choose-tidb-to-support-reposcope/javascript-framework-rankings.png)
...
After we released Reposcope on May 3, we have received loud applause on social media, via emails and private messages, from many developers, engineers, researchers, and people who are passionate about the open source community in various companies and industries. 

I am more than excited and grateful that so many people find Reposcope interesting, helpful, and valuable. I am also proud that my team made such a wonderful product in such a short time. 

<br />

![Applause given by developers and organizations on Twitter-1](/blog-assets/why-we-choose-tidb-to-support-reposcope/twitter-1.png)

![Applause given by developers and organizations on Twitter-1](/blog-assets/why-we-choose-tidb-to-support-reposcope/twitter-2.jpg)
...
If you like our project or are interested in joining us, you’re welcome to **[submit your PRs](https://github.com/reposcope/reposcope)** to our GitHub repository. You can also follow us on [Twitter](https://twitter.com/Reposcope) for the latest information. 
