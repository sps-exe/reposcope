---
id: reposcope-public-api
title: "Reposcope Public API"
description: "Reposcope Public APIs (beta) provide a convenient way to access insight data for open source projects on GitHub, supplementing the existing GitHub API."
...
<span className={"theme-doc-version-badge badge badge--secondary"}>Version: v1beta</span>
