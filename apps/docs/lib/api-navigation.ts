...
export const apiShowcaseLinks = [
  ...
  { href: 'https://www.raycast.com/k8scat/reposcope', label: 'Raycast Reposcope', description: 'A Raycast extension powered by Reposcope APIs.' },
  { href: 'https://github.com/tsui66/ChatGH', label: 'ChatGH', description: 'Chat with GitHub APIs using natural language.' },
  { href: 'https://github.com/hooopo/reposcope-x', label: 'reposcope-x', description: 'Automatically post trending repositories to social media every day.' },
];
