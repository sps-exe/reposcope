  ...
  instance.setOption({
    ...
    graphic: [
      ...
      },
      {
        ...
        right: 60,
        bottom: 40,
        style: { text: 'reposcope.io', fontSize: 28, fontWeight: 500, fontFamily: "'Inter', -apple-system, sans-serif", fill: 'rgba(255,255,255,0.4)' },
      },
    ],
    series: [{
      type: 'treemap',
...
export default function AIHomeContent({ categories, trendingRepos }: AIHomeProps) {
  ...
  const handleExport4K = useCallback(async () => {
    ...
    triggerDownload(url, 'reposcope-trending-4k.png');
  }, []);
