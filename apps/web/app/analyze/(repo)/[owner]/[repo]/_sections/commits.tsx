  ...
  return (
    <ScrollspySectionWrapper anchor="commits" className="pt-8 pb-8">
      ...
      <RepoChart
        ...
        name="@reposcope/widget-analyze-repo-pushes-and-commits-per-month"
      ...
      <RepoChart
        ...
        name="@reposcope/widget-analyze-repo-loc-per-month"
      ...
      <RepoChart
        ...
        name="@reposcope/widget-analyze-repo-commits-time-distribution"
