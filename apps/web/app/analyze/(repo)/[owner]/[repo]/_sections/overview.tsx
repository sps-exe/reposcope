  ...
  return (
    <div className="h-full">
      ...
      <div className="mt-3 grid grid-cols-2 gap-3">
        <div className="rounded-[6px] bg-[#151927] px-3 py-3">
          <RepoChart
            name="@reposcope/widget-analyze-repo-recent-stars"
        ...
        <div className="rounded-[6px] bg-[#151927] px-3 py-3">
          <RepoChart
            name="@reposcope/widget-analyze-repo-recent-pull-requests"
        ...
        <div className="rounded-[6px] bg-[#151927] px-3 py-3">
          <RepoChart
            name="@reposcope/widget-analyze-repo-recent-issues"
        ...
        <div className="rounded-[6px] bg-[#151927] px-3 py-3">
          <RepoChart
            name="@reposcope/widget-analyze-repo-recent-commits"
      ...
      <div id="overview-main">
        {repoInfo ? (
          <>
            <ShareButtons
              ...
              title={`${repoName} — check the full analytics on Reposcope`}
        ...
        <div className="mt-6 grid grid-cols-1 items-start gap-6 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)]">
          ...
          <div>
            {vs ? (
              <RepoChart
                name="@reposcope/widget-analyze-repo-stars-history"
      ...
      <div className="flex items-center gap-3">
        ...
        <div ref={dropdownRef} className="relative">
          ...
          {showDropdown && displayList.length > 0 && (
            <div className="absolute left-0 top-full z-50 mt-1 max-h-80 w-[320px] overflow-y-auto rounded-md border border-[#4a4a4a] bg-[#12151f] shadow-xl">
