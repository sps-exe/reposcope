...
A REST API endpoint designed for AI agents and MCP (Model Context Protocol) clients to access Reposcope data programmatically.

**Base URL:** `https://reposcope.io/api/mcp`
...
curl "https://reposcope.io/api/mcp?action=collections"

# Get AI Agent Frameworks ranking
curl "https://reposcope.io/api/mcp?action=ranking&collectionId=10009&metric=stars&range=last-28-days"

# Search for "vector database"
curl "https://reposcope.io/api/mcp?action=search&q=vector%20database"

# Get trending AI repos
curl "https://reposcope.io/api/mcp?action=trending&language=Python&period=past_month"

# Compare two repos
curl "https://reposcope.io/api/mcp?action=compare&repo1=facebook/react&repo2=vuejs/vue"
```
