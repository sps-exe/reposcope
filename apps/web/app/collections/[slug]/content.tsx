  ...
  return (
    <header>
      ...
      <ShareButtons
        ...
        title={`Check out the ${collectionName} collection on Reposcope — top open source projects ranked by stars, PRs, and issues`}
  ...
  const { option, height } = useMemo(() => {
    ...
    return {
      ...
      option: {
        ...
        grid: { left: 40, right: 220, top: 32, bottom: 30, containLabel: false },
        xAxis: {
          type: 'category',
          position: 'top',
          boundaryGap: ['8%', '6%'],
