  ...
  return [
    {
      ...
      answer: `Reposcope tracks the most popular ${collectionName} repositories on GitHub, ranked by stars, pull requests, issues, and contributors. Visit the ranking table above to see the current top projects.`,
    },
    {
    ...
    },
    {
      ...
      answer: 'Rankings are updated in near real-time based on GitHub events processed by Reposcope, so you always see the latest activity.',
    },
    {
