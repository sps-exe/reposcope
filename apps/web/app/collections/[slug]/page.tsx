...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const ogTitle = `${collection.name} — Top GitHub Repositories & Rankings 2026 | Reposcope`;
  return {
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          Rankings and trends for the {collection.name} collection on Reposcope.
        ...
        <p>
          Reposcope tracks over 10 billion GitHub events to provide real-time rankings.
