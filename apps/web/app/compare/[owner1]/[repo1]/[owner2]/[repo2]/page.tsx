  ...
  return (
    <>
      ...
      <RepoAnalyzePage
        ...
        vsName={vsName}
      />
      <ShareButtons url={`/compare/${owner1}/${repo1}/${owner2}/${repo2}`} title={`${owner1}/${repo1} vs ${owner2}/${repo2} — compare on Reposcope`} />
    </>
  );
}
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title,
    description,
    keywords: ['Reposcope', 'GitHub', 'comparison', repo1, repo2, owner1, owner2, name1, name2],
