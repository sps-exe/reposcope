  ...
  return (
    <div ref={containerRef} style={{ position: 'relative', maxWidth: 500 }} className="ml-auto mt-6">
      ...
      <div style={{
        ...
        />
        {loading && (
          <svg width="16" height="16" viewBox="0 0 24 24" className="animate-spin" style={{ color: '#22d3ee' }}>
      ...
      {open && (
        <div style={{
              ...
              {SEARCH_TABS.map(t => (
                <Tabs.Trigger
                  ...
                  style={{
                    ...
                    background: 'none', color: searchType === t.value ? '#22d3ee' : '#8c8c8c',
                    borderBottom: searchType === t.value ? '2px solid #22d3ee' : '2px solid transparent',
          ...
          {/* Keyboard hints bar */}
          <div style={{
            height: 32, padding: '0 12px', backgroundColor: '#12151f',
            display: 'flex', alignItems: 'center', gap: 16, fontSize: 11, color: '#8c8c8c',
          }}>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
              <span style={{ minWidth: 24, height: 24, borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)', backgroundColor: '#0b0e14', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, color: '#a7a9b6', padding: '0 4px' }}>TAB</span>
              <span style={{ minWidth: 24, height: 24, borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)', backgroundColor: '#0b0e14', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, color: '#a7a9b6' }}>↑</span>
              <span style={{ minWidth: 24, height: 24, borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)', backgroundColor: '#0b0e14', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, color: '#a7a9b6' }}>↓</span>
              To Navigate
            </span>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
              <span style={{ minWidth: 24, height: 24, borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)', backgroundColor: '#0b0e14', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, color: '#a7a9b6', padding: '0 4px' }}>ESC</span>
              To Cancel
            </span>
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
              <span style={{ minWidth: 24, height: 24, borderRadius: 6, border: '1px solid rgba(255,255,255,0.08)', backgroundColor: '#0b0e14', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, color: '#a7a9b6' }}>↵</span>
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-400 text-sm mb-8">
        Everything you need to know about Reposcope.
      </p>
        ...
        {FAQ_ITEMS.map((item, i) => {
          ...
          return (
            <div
              ...
              style={{ backgroundColor: isOpen ? '#151927' : '#0b0e14' }}
            >
              <button
                type="button"
                onClick={() => toggle(i)}
    ...
    <footer className="border-t border-gray-800 mt-12 py-10 px-6">
      <div className="max-w-[1536px] mx-auto">
        ...
        <div className="text-center mb-10">
          <p className="text-lg">
            Follow us at <a href="https://twitter.com/Reposcope" target="_blank" rel="noopener noreferrer" className="site-link">@Reposcope</a> and join the conversation using the hashtags
          </p>
          <p className="font-bold text-lg mt-1">#Reposcope #OpenSource</p>
          <div className="mt-4 flex justify-center">
            <div className="inline-flex overflow-hidden rounded-md border border-white/10 bg-white/[0.03] shadow-[0_18px_45px_-28px_rgba(0,0,0,0.82)]">
              <a
                ...
                href="https://github.com/reposcope/reposcope"
                rel="noopener noreferrer"
                target="_blank"
                aria-label="Star reposcope/reposcope on GitHub"
              >
              ...
              <a
                ...
                href="https://github.com/reposcope/reposcope/stargazers"
                rel="noopener noreferrer"
                target="_blank"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
          <div>
            <h4 className="font-bold mb-3">Reposcope</h4>
        ...
        <div className="text-center text-xs text-gray-500 mt-10">
          Copyright &copy; {new Date().getFullYear()} Reposcope. All Rights Reserved. | <a href="/privacy" target="_blank" rel="noopener noreferrer" className="hover:text-white">Privacy</a>
        </div>
      </div>
    </footer>
  );
