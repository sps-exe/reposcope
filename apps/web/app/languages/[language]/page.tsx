...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      'GitHub', language, 'trending', 'repositories', 'open source', 'Reposcope',
    ],
...
export default async function LanguagePage({ params }: PageProps) {
  ...
  const jsonLd = {
    ...
    url: `https://reposcope.io/languages/${encodeURIComponent(language)}`,
    isPartOf: {
      '@type': 'WebSite',
      name: 'Reposcope',
        ...
        <div className="flex gap-8">
          ...
          <div className="min-w-0 flex-1">
            <ShareButtons
              ...
              title={`Trending ${language} repositories on Reposcope`}
            />
