  ...
  return (
    <div className="min-h-screen bg-[#0b0e14] flex flex-col items-center justify-center px-6 text-white">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Link
          href="/"
          className="inline-flex items-center justify-center rounded-lg bg-white text-[#0b0e14] font-semibold px-6 py-3 hover:bg-white/90 transition-colors"
        >
          ← Back to Home
        </Link>
        <Link
      ...
      <div className="mt-16 text-white/20 text-sm">
        Reposcope — Open Source Software Insight
      </div>
    </div>
  );
}
