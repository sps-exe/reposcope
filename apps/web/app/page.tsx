...
export const metadata: Metadata = {
  title: {
    absolute: 'Reposcope — AI Agent Analytics & Open Source GitHub Intelligence',
  },
  ...
  openGraph: {
    title: 'Reposcope — AI Agent Analytics & Open Source GitHub Intelligence',
    ...
    images: [{ url: '/seo-widgets-homepage.jpeg', width: 1200, height: 630, alt: 'Reposcope — AI Agent Analytics & Open Source GitHub Intelligence' }],
  },
  twitter: {
    title: 'Reposcope — AI Agent Analytics & Open Source GitHub Intelligence',
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          Reposcope is a free analytics platform that tracks over 10 billion GitHub events in real time.
