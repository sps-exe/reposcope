...
export function TrendingAIContent({
  ...
  return (
    <div className="min-h-screen bg-[#0b0e14]">
      {/* Hero Section */}
      <section className="relative overflow-hidden border-b border-[#363638] bg-gradient-to-b from-[#0b0e14] to-[#121212] py-16 md:py-24">
        ...
        <div className="relative mx-auto max-w-6xl px-4 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#363638] bg-[#12151f] px-4 py-1.5 text-sm text-[#c6c6d0]">
            ...
            <button
              ...
              className={cn(
                ...
                activeCategory === cat.key
                  ...
                  : 'border border-[#363638] bg-[#12151f] text-[#c6c6d0] hover:border-white hover:text-white',
              )}
            >
              {cat.label}
            </button>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
              {topMovers.map((repo, idx) => (
                <Link
                  ...
                  className="group rounded-lg border border-[#363638] bg-[#12151f] p-4 transition-colors hover:border-white"
                >
        ...
        <section className="mb-10">
          ...
          <div className="overflow-x-auto rounded-lg border border-[#363638]">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#363638] bg-[#12151f]">
              ...
              <tbody>
                ...
                {filteredRepos.map((repo, idx) => (
                  <tr
                    key={repo.repo_name}
                    className="border-b border-[#29292a] transition-colors hover:bg-[#12151f]"
                  >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {initialData.categories.map((cat) => {
              ...
              return (
                <div
                  key={cat.id}
                  className="rounded-lg border border-[#363638] bg-[#12151f] p-5"
                >
