...
const TITLE = 'Trending AI Repositories on GitHub — Real-Time Rankings 2026 | Reposcope';
const DESCRIPTION =
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'The most popular AI repositories on GitHub span categories like AI agent frameworks (e.g., LangChain, AutoGPT), LLM tools, MCP servers, coding agents, and more. Reposcope tracks real-time star growth and contributor activity across 10B+ GitHub events to rank these projects.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'The data is refreshed every hour using real-time GitHub event data. Reposcope processes over 10 billion GitHub events to provide up-to-date rankings of stars, pull requests, issues, and contributor activity.',
  },
  {
    question: 'Can I analyze a specific AI repository in more detail?',
    answer:
      'Yes! Click on any repository name to visit its detailed analytics page on Reposcope, where you can explore star history, commit activity, contributor growth, pull request trends, and more.',
  },
];
    ...
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          ...
          Powered by Reposcope&apos;s analysis of over 10 billion GitHub events.
        </p>
      </div>
