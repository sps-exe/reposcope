...
export interface WordCloudOptions<Params extends Record<string, any> = Record<string, any>> {
...
export async function renderWordCloud<Params extends Record<string, any>>(
