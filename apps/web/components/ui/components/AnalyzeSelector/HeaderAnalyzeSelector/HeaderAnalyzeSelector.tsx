  ...
  return (
    <div className='relative'>
      ...
      <Input
        ...
        name='header-search'
        id='header-search'
        className='h-11 rounded-sm border-white/10 bg-[#12151f] pl-9 text-[#eef0f5] placeholder:text-[#84879a] focus-visible:border-white/45 focus-visible:ring-2 focus-visible:ring-white/18'
