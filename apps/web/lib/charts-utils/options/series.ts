...
// Local shims for echarts internal types (deep paths removed in echarts 5.6).
type DimensionLoose = string | number;
type OptionEncodeValue = string | number | Array<string | number>;
