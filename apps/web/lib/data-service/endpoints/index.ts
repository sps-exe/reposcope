...
// `config` is typed as `any` on purpose: params.json values are inferred as
// widened primitives (`type: string`) which don't satisfy the literal unions
// in EndpointConfig. Consumers treat it as EndpointConfig at runtime.
...
endpointLoaders.set("orgs/repos/active/ranking", () => import("./orgs/repos/active/ranking"));
endpointLoaders.set("orgs/repos/active/total", () => import("./orgs/repos/active/total"));
