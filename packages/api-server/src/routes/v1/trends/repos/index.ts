...
☁️ Daily run on [TiDB Cloud](https://tidbcloud.com/?utm_source=reposcope&utm_medium=reposcope_api), analyze upon dataset that has over 6 billion GitHub events.`,
  tags: ['Trends'],
  querystring: {
    type: 'object',
    properties: {
