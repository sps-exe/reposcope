...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-[13px] font-medium whitespace-nowrap text-[#e9eaee] shadow-[0_12px_30px_-18px_rgba(0,0,0,0.85)] transition-[background-color,border-color,color,box-shadow,transform] outline-none select-none focus-visible:border-[#22d3ee]/45 focus-visible:ring-2 focus-visible:ring-[#22d3ee]/18 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "border-[#22d3ee]/55 bg-[#22d3ee] text-[#1f1e28] shadow-[0_18px_35px_-24px_rgba(255,232,149,0.85)] hover:border-[#fff0b7] hover:bg-[#fff0b7]",
        outline: "border-white/10 bg-white/[0.03] text-[#d8dae3] hover:border-[#22d3ee]/30 hover:bg-white/[0.06] hover:text-[#f6f7fb] aria-expanded:border-[#22d3ee]/30 aria-expanded:bg-white/[0.06] aria-expanded:text-[#f6f7fb]",
        secondary: "border-transparent bg-[var(--background-color-control)] text-[#22d3ee] shadow-[0_18px_38px_-28px_rgba(0,0,0,0.9)] hover:bg-[rgb(43,43,45)] aria-expanded:bg-[rgb(43,43,45)] aria-expanded:text-[#fff0b7]",
...
export const Input = React.forwardRef<HTMLInputElement, React.ComponentProps<"input">>(
  ({ className, type, ...props }, ref) => (
    <input
      ...
      data-slot="input"
      className={cn(
        "flex h-10 w-full min-w-0 rounded-md border border-white/10 bg-[var(--background-color-control)] px-3.5 py-2 text-sm text-[#e9eaee] shadow-[0_10px_24px_-18px_rgba(0,0,0,0.88)] transition-[border-color,box-shadow,background-color,color] outline-none placeholder:text-[#87879a] focus-visible:border-[#22d3ee]/45 focus-visible:bg-[var(--background-color-control)] focus-visible:ring-2 focus-visible:ring-[#22d3ee]/16 disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    />
