    ...
    <li>
      <NavLink
        ...
        className={clsx(
          ...
          'hover:text-[#22d3ee] focus-visible:text-[#22d3ee] focus-visible:ring-2 focus-visible:ring-[#22d3ee]/20',
          active && 'bg-white/[0.04] text-[#22d3ee]',
        )}
      >
...
export function SiteHeader({
  ...
  return (
    ...
    >
      <NavLink href={homeHref} className="shrink-0 rounded-lg p-1 outline-none focus-visible:ring-2 focus-visible:ring-[#22d3ee]/20">
